...
names += ['evidence/'+n for n in ['paper_sources.json','seed_comparison.json','slap_sweep.json','competition_final.json','final_dedup.json','PAPER_EVIDENCE.md','molecule_example.json','competitors.json','unswept.json','checkpoint_verdict_audit.json','golden_miss_analysis.json','direction_recovery.json','timing_comparison.json','coordinate_minima.json','multicandidate_example.json','output_multiplicity.json','coordinate_case127.json']]
names += ['scripts/'+n for n in ['build.sh','build_figures.py','validate_outputs.py','package_bundle.py','build_molecule_figure.py','build_alternatives_figure.py']]
