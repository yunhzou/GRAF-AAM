...
names += ['evidence/'+n for n in ['paper_sources.json','seed_comparison.json','slap_sweep.json','competition_final.json','final_dedup.json','PAPER_EVIDENCE.md','molecule_example.json','competitors.json']]
