...
names += ['includes/'+n for n in ['include-abstract.tex','include-acknowledgement.tex','include-body.tex','include-appendix.tex','paper.tex','supplement.tex','generated-cap-ablation-table.tex','generated-decoder-table.tex','generated-results.tex','generated-competitor-table.tex','generated-miss-table.tex','generated-direction-table.tex','generated-coordinate-minima-table.tex','generated-coordinate-time-table.tex','generated-end-to-end-table.tex','generated-end-to-end-text.tex','generated-end-to-end-scope.tex']]
names += ['figs/'+stem+'.'+ext for stem in ['fig1_algorithm','fig2_golden','fig3_coordinate','fig4_alternatives'] for ext in ['pdf','svg','png']]
names += ['evidence/'+n for n in ['author-affiliations.md','paper_sources.json','seed_comparison.json','slap_sweep.json','final_dedup.json','PAPER_EVIDENCE.md','molecule_example.json','competitors.json','unswept.json','checkpoint_verdict_audit.json','golden_miss_analysis.json','direction_recovery.json','timing_comparison.json','coordinate_minima.json','golden_cap_ablation.json','multicandidate_example.json','output_multiplicity.json','golden_case9.json','golden_case9_verification.json','end_to_end_timing.json']]
