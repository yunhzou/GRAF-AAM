...
names += ['includes/'+n for n in ['include-abstract.tex','include-body.tex','include-appendix.tex','paper.tex','supplement.tex','generated-seed-table.tex','generated-decoder-table.tex','generated-results.tex','generated-competitor-table.tex','generated-miss-table.tex','generated-direction-table.tex','generated-comparator-timing-table.tex']]
names += ['figs/'+stem+'.'+ext for stem in ['fig1_algorithm','fig2_golden','fig3_coordinate'] for ext in ['pdf','svg','png']]
names += ['evidence/'+n for n in ['paper_sources.json','seed_comparison.json','slap_sweep.json','competition_final.json','final_dedup.json','PAPER_EVIDENCE.md','molecule_example.json','competitors.json','unswept.json','checkpoint_verdict_audit.json','golden_miss_analysis.json','direction_recovery.json','timing_comparison.json']]
