...
subprocess.run([ffmpeg,'-v','error','-y','-i',str(a.directory/'molecule-verification.mp4'),
    ...
    '-loop','0',str(a.directory/'molecule-verification-preview.gif')],check=True)
subprocess.run([ffmpeg,'-v','error','-y','-ss','24','-i',str(a.directory/'molecule-verification.mp4'),
