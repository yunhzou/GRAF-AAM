...
summary['current_source_sha256']={name:hashlib.sha256((ROOT/'work/aam-event-improved/src/graft'/name).read_bytes()).hexdigest() for name in ['final_branches.py','search_graph.py','domain.py','analytical.py']}
